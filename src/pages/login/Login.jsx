        ...
        <div className="h-screen bg-gradient-to-br from-[#ff6867] flex flex-col items-center justify-center text-center">
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                <div className="card-body">
                    <h1 className="text-xl font-bold text-[#ff6867]">Please Login</h1>
                    <form className="fieldset">
                        ...
                        <div className="text-left"><p>New Here? Please <Link to={"/register"} className="text-[#ff6867]">Register</Link></p></div>
                        <button className="btn bg-gradient-to-r from-[#ff6867] mt-4 text-white border-none shadow-none">Login</button>
